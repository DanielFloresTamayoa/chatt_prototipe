...
import { Auth, createUserWithEmailAndPassword, onAuthStateChanged, sendPasswordResetEmail } from '@angular/fire/auth';
  ...
  async register(formValue) {
    try {
      ...
      const data = {
        ...
        photo: 'https://i.provatar.cc/' + this.randomIntFromInterval(200, 400)
      };
